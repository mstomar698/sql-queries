        ...
        d = {
                ...
                if (
                  ...
                  for (
                    ...
                    j[g] instanceof fabric.Triangle
                      ? ((e.color || e.opacity) && j[g].set({ fill: e.color }),
                        e.fontSize && j[g].set({ fontSize: e.fontSize }))
                      : (j[g] instanceof fabric.Path ||
                          j[g] instanceof fabric.Line) &&
                        (i instanceof fabric.Group
                          ? (e.color || e.opacity) &&
                            j[g].set({ stroke: e.color })
                          : ((e.color || e.opacity) &&
                              j[g].set({ stroke: e.color }),
                            e.width && j[g].set({ strokeWidth: e.width })));
                  b ||
                    ((f = JSON.stringify(
                ...
                if (
                  ...
                  if (b.arrow) {
                    ...
                    return (
                      ...
                      "change" == b.action && d.setup.fabric.setActiveObject(i),
          ...
          gatherClassName: function (a, b, c, e) {
            ...
            if (d.isElement(a)) {
              if (
                ((f =
                  (a.getAttribute("class") || "").split(" ").indexOf(b) != -1),
                !f && e < c)
              )
          ...
          modifyFabric: function () {
            (fabric.ElementsParser.prototype.resolveMega = function (a, b) {
              var c = a.get(b);
              if (/^url\(/.test(c)) {
                var e = c.slice(c.indexOf("#") + 1, c.length - 1);
                if (fabric.gradientDefs[this.svgUid][e]) {
                  var f = fabric.Mega.fromElement(
                ...
                var l = i.items[c],
                  k = {
                    ...
                    legend: {
                      id: c,
                      type:
                        ["top", "left"].indexOf(d.config.legend.position) != -1
                          ? "unshift"
                          : "push",
            ...
            for (
              d.setup.canvas = document.createElement("canvas"),
                ...
                d.setup.fabric = new fabric.Canvas(
                  d.setup.canvas,
                  d.deepMerge(
                    { width: g.width, height: g.height, isDrawingMode: !0 },
                    e
                  )
                ),
                          ...
                          : e instanceof fabric.Triangle &&
                            ...
                            "start" == h.arrow
                              ? ((f = h.y1 + h.width / 2),
                                (g = h.x1 + h.width / 2))
                              : "middle" == h.arrow
                              ? ((f = h.y2 + h.width / 2 - (h.y2 - h.y1) / 2),
                                (g = h.x2 + h.width / 2 - (h.x2 - h.x1) / 2))
                              : ((f = h.y2 + h.width / 2),
                                (g = h.x2 + h.width / 2)),
                ...
                d.setup.fabric.on("path:created", function (a) {
                  ...
                  if (!d.drawing.buffer.isDrawing || d.drawing.buffer.hasLine)
                    return (
                      d.setup.fabric.remove(b), void d.setup.fabric.renderAll()
                    );
                }),
                      ...
                      for (
                        a.offset.absolute
                          ? (void 0 !== a.offset.bottom
                              ? (n.top =
                                  g.height - a.offset.height - a.offset.bottom)
                              : (n.top = a.offset.top),
                            void 0 !== a.offset.right
                              ? (n.left =
                                  g.width - a.offset.width - a.offset.right)
                                ...
                                return function (e) {
                                  ...
                                  "map" == d.setup.chart.type &&
                                    ...
                                    f.bbox.x &&
                                      ...
                                      f.bbox.y &&
                                      g[5] &&
                                      ((h.top -= g[5]), (h.left -= g[4])),
                                    void 0 !==
                                      d.setup.chart.smoothCustomBullets &&
                                    this.className ==
                                      d.setup.chart.classNamePrefix +
                                        "-graph-bullet" &&
                                    "image" == l.paths[b].svg.tagName
                                      ? ((radius =
                                          f.svg.firstChild.rx.baseVal.value /
                                            2 +
                                          2),
                                        e.beginPath(),
                                        e.moveTo(h.left + radius, h.top),
                                        e.lineTo(
                                          h.left + h.width - radius,
                                          h.top
                                        ),
                                        e.quadraticCurveTo(
                                          h.left + h.width,
          ...
          toPDF: function (a, b) {
            ...
            function g(a, b) {
              var c =
                d.defaults.pdfMake.pageSizes[String(a).toUpperCase()].slice();
              if (!c)
                throw new Error(
          ...
          toArray: function (a, b) {
            ...
            if (
              ((f.processData = k),
              (f.data =
                void 0 !== f.data ? d.processData(f) : d.getChartData(f)),
              f.withHeader)
            ) {
              i = [];
          ...
          toByteArray: function (a, b) {
            ...
            function m(a) {
              ...
              var i = a.length;
              (g =
                "=" === a.charAt(i - 2) ? 2 : "=" === a.charAt(i - 1) ? 1 : 0),
          ...
          handleDropbox: function (a) {
            if (d.drawing.enabled)
              if (
                (a.preventDefault(), a.stopPropagation(), "dragover" == a.type)
              )
                d.setup.wrapper.setAttribute(
                  "class",
                  d.setup.chart.classNamePrefix +
                    ...
                    c.dateFields.indexOf(k) != -1 &&
                      ...
                      c.exportSelection &&
                        (m instanceof Date
                          ...
                          : (e < a.startIndex || e > a.endIndex) && (i = !0)),
                      c.dateFormat &&
                          ...
                          return function (b) {
                            function j(a) {
                              var b = a.parentNode.parentNode,
                                c = b.classList;
                              return !(
                                "LI" != b.tagName || !c.contains("active")
                              );
                            }
                            function k(a) {
                            ...
                            function m(a) {
                              return (
                                a.classList.contains("export-main") ||
                                a.classList.contains("export-drawing")
                              );
                            }
                            b.preventDefault();
                            var c = a.elements.li,
