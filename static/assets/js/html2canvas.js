...
(function (global, factory) {
  ...
  var _lineBreakAtIndex = function (
    ...
    if (indicies[index] === 0) {
      return BREAK_numberT_ALLOWED$1;
    }
  ...
  var LineBreaker = function (str, options) {
    ...
    return {
      next: function () {
        ...
        var lineBreak = BREAK_numberT_ALLOWED$1;
        while (
          nextIndex < length &&
          ...
          )) === BREAK_numberT_ALLOWED$1
        ) {}
        if (lineBreak !== BREAK_numberT_ALLOWED$1 || nextIndex === length) {
  ...
  var GraphemeBreaker = function (str) {
    ...
    return {
      next: function () {
        ...
        var graphemeBreak = BREAK_numberT_ALLOWED;
        while (
          index < length &&
          (graphemeBreak = _graphemeBreakAtIndex(
            ...
            classTypes,
            ++index
          )) === BREAK_numberT_ALLOWED
        ) {}
        if (graphemeBreak !== BREAK_numberT_ALLOWED || index === length) {
  ...
  var isTextNode = function (node) {
    return node.nodeType === Node.TEXT_numberDE;
  };
  var isElementNode = function (node) {
    return node.nodeType === Node.ELEMENT_numberDE;
  };
