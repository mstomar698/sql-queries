    ...
    function a(o, l) {
      if (!n[o]) {
        if (!e[o]) {
          ...
          throw ((u.code = "MODULE_numberT_FOUND"), u);
        }
        var d = (n[o] = { exports: {} });
        e[o][0].call(
          d.exports,
                ...
                advance: function (t) {
                  for (var n, i, a = this.animations, r = 0; r < a.length; )
                    (n = a[r]),
                      ...
                      (n.currentStep = Math.min(n.currentStep, n.numbersteps)),
                      e.callback(n.render, [i, n], i),
                      e.callback(n.onAnimationProgress, [n], i),
                      n.currentStep >= n.numbersteps
                  ...
                  if (r.notify(i, "beforeRender") !== !1) {
                    ...
                    if (
                      ...
                      var s = new t.Animation({
                        numbersteps: (e || o.duration) / 16.66,
                        easing: o.easing,
                        render: function (t, e) {
                      ...
                      i.draw(),
                        l(new t.Animation({ numbersteps: 0, chart: i }));
                    return i;
                  }
                },
                draw: function (t) {
